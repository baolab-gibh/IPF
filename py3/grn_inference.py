...
# Specify model path; here we load the pre-trained scGPT lung model
model_dir = Path("../inputs/scGPT/pretrained_models/lung").resolve()
...
# Loading data and apply the model
data_dir = Path("../data")
...
# Preprocess the data following the scGTP data preprocessing pipeline.
